...
import type { Article } from '@/app/[locale]/(news)/_types';
import { TEXT } from '@/constants/text';
import { createTestStore } from '@/__tests__/store';
import { mockArticle } from '@/__tests__/mocks';
import { toggleSelectNews } from '@/app/[locale]/(news)/_store';
...
vi.mock('@news/api/newsApi', async (importOriginal) => {
  const actual =
    await importOriginal<typeof import('@/app/[locale]/(news)/_api/newsApi')>();
